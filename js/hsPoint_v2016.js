...
//				if(count>200){return false;}//只接收二百点
//				else{cxt.stroke();}
	...
	function result(score,statu){
		...
		$(".tan .shareBtn1").tap(function(){
			...
			//左边结束时引导分享朋友圈
				...
				$(".arrow").show();
				$(".neiRong .btns .shareBtn1").val("我自己来吧").addClass("bySelf");//2016年3月1日15:55:39
				$(".bySelf").tap(function(){
					window.location.href = "drawRight.html?rl="+record_left+"&fl="+score;
				});
			}
		})
	}
...
//	alert(Request["rl"]);
	...
	//关注公众账号（暂时跳转结果页）
	$(".follow").tap(function(){
		window.location.href = 'result.html?rl='+Request["rl"]+"&fl="+Request["fl"]+"&rt="+record_right+"&fr="+score;
	})
	//下载慧车宝
